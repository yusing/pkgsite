...
import (
	...
	"github.com/yusing/pkgsite/internal/godoc/importer"
...
func TestVersionedPkgPath(t *testing.T) {
	for _, test := range []struct {
		...
		},
		{
			...
			pkgPath: "github.com/yusing/pkgsite/internal/log",
			modInfo: &ModuleInfo{
				ModulePath:      "github.com/yusing/pkgsite",
				ResolvedVersion: "v1.1.2",
				ModulePackages:  map[string]bool{"github.com/yusing/pkgsite/internal/log": true},
			},
			want: "github.com/yusing/pkgsite@v1.1.2/internal/log",
		},
		{
			...
			want: "github.com/yusing/pkgsite@v0.0.0-20200709011933-a59b4ce778c4/internal/log",
		},
		{
